# df생성 후 split시 train val test 겹치는 데이터 방지
import os
import glob
import pandas as pd
from sklearn.model_selection import train_test_split

ROOT = r"D:\Foot\v3-1024\_rp(n)-rp(n+1)_1024"
...
subj_trainval, subj_test = train_test_split(
    subj_df, test_size=0.2, stratify=subj_df["label"], random_state=42
)

subj_train, subj_val = train_test_split(
    subj_trainval, test_size=0.2, stratify=subj_trainval["label"], random_state=42
)
...
SAVE_DIR = r"D:\Foot\Dataset\v3-1024\_rp(n)-rp(n+1)_1024"
